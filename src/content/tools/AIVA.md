...
---
Full feature set except API, scheduling and gateways
No-code visual test creation and execution
1 account with one workspace
1 parallel test execution in a shared queue
1 week video recording retention
